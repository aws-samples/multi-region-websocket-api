...
This repository contains the full source code that is used in the blog post [Building serverless multi-region WebSocket APIs with Amazon API Gateway, AWS Lambda and Amazon DynamoDB ](https://aws.amazon.com/blogs/compute/).
...
```
// List of regions to deploy the application to
...
```
cdk synth 
# replace account id and regions
